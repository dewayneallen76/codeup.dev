    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Dewayne Allen</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        <h1>Dewayne Allen</h1>
                        <h3>Codeup Web Developer in Training</h3>
                        <hr class="intro-divider">
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="https://facebook.com/dewayne.allen1" target="blank" class="btn btn-default btn-lg"><i class="fa fa-twitter fa-fw"></i> <span class="network-name">Facebook</span></a>
                            </li>
                            <li>
                                <a href="https://github.com/dewayneallen76" target="blank" class="btn btn-default btn-lg"><i class="fa fa-github fa-fw"></i> <span class="network-name">Github</span></a>
                            </li>
                            <!-- <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="copyright text-muted small">Copyright &copy; Dewayne Allen 2016. All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
